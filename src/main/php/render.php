...
try {
    ...
    $reportDocument = $birtEngine->openReportDocument(__DIR__."$reportDocumentName.rptdocument");
    ...
    if ($format == "html") {
        ...
        $htmlOptions->setImageDirectory(__DIR__);
        $htmlOptions->setBaseImageURL("http://localhost");
